...
class APICallDecoderDeclarationsGeneratorOptions(GeneratorOptions):
...
# genCmd(cmdinfo)
class APICallDecoderDeclarationsOutputGenerator(OutputGenerator):
    ...
    def genCmd(self, cmdinfo, name, alias):
        ...
        if not name in self.APICALL_BLACKLIST:
            cmddef = '    size_t Decode_{}(const uint8_t* parameter_buffer, size_t buffer_size);\n'.format(name)
