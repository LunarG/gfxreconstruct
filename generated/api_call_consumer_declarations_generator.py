...
class APICallConsumerDeclarationsGeneratorOptions(GeneratorOptions):
...
# genCmd(cmdinfo)
class APICallConsumerDeclarationsOutputGenerator(OutputGenerator):
    ...
    def genCmd(self, cmdinfo, name, alias):
        ...
        if not name in self.APICALL_BLACKLIST:
            cmddef = 'virtual ' + self.makeConsumerDecl(cmdinfo.elem, 'Process_') + ' = 0;'
    ...
    def makeConsumerDecl(self, cmd, prefix = ''):
        """Generate VulkanConsumer class memebr declaration for <command> Element"""
        returnType = None
