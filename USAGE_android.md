...
| Page guard use libsigchain         | debug.gfxrecon.page_guard_use_libsigchain              | BOOL    | Android libsigchain gives the ability to install signal handler with elevated priority compared to sigaction. This is used by default on Android to install the SIGSEGV handler but sometimes this can cause problems. This options gives the ability to switch to using sigaction. Default is  `true`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
