...
const std::unordered_map<std::string, PFN_vkVoidFunction> func_table = {
    ...
    { "vkBindAccelerationStructureMemoryKHR",                                                                reinterpret_cast<PFN_vkVoidFunction>(encode::BindAccelerationStructureMemoryKHR) },
    ...
    { "vkGetAccelerationStructureMemoryRequirementsKHR",                                                     reinterpret_cast<PFN_vkVoidFunction>(encode::GetAccelerationStructureMemoryRequirementsKHR) },
    { "vkCmdBuildAccelerationStructureKHR",                                                                  reinterpret_cast<PFN_vkVoidFunction>(encode::CmdBuildAccelerationStructureKHR) },
    { "vkCmdBuildAccelerationStructureIndirectKHR",                                                          reinterpret_cast<PFN_vkVoidFunction>(encode::CmdBuildAccelerationStructureIndirectKHR) },
    { "vkBuildAccelerationStructureKHR",                                                                     reinterpret_cast<PFN_vkVoidFunction>(encode::BuildAccelerationStructureKHR) },
