    ...
    const HandlePointerDecoder<VkInstance>&     pInstance)
{
    ...
    VkResult replay_result = OverrideCreateInstance(vkCreateInstance, returnValue, in_pCreateInfo, in_pAllocator, out_pInstance);
    ...
    const HandlePointerDecoder<VkPhysicalDevice>& pPhysicalDevices)
{
    ...
    VkResult replay_result = vkEnumeratePhysicalDevices(in_instance, out_pPhysicalDeviceCount, out_pPhysicalDevices);
    ...
    const StructPointerDecoder<Decoded_VkImageFormatProperties>& pImageFormatProperties)
{
    ...
    VkResult replay_result = vkGetPhysicalDeviceImageFormatProperties(in_physicalDevice, format, type, tiling, usage, flags, out_pImageFormatProperties);
    ...
    const HandlePointerDecoder<VkDevice>&       pDevice)
{
    ...
    VkResult replay_result = OverrideCreateDevice(vkCreateDevice, returnValue, in_physicalDevice, in_pCreateInfo, in_pAllocator, out_pDevice);
    ...
    format::HandleId                            fence)
{
    ...
    VkResult replay_result = vkQueueSubmit(in_queue, submitCount, in_pSubmits, in_fence);
    ...
    format::HandleId                            queue)
{
    ...
    VkResult replay_result = vkQueueWaitIdle(in_queue);
    ...
    format::HandleId                            device)
{
    ...
    VkResult replay_result = vkDeviceWaitIdle(in_device);
    ...
    const HandlePointerDecoder<VkDeviceMemory>& pMemory)
{
    ...
    VkResult replay_result = vkAllocateMemory(in_device, in_pAllocateInfo, in_pAllocator, out_pMemory);
    ...
    const StructPointerDecoder<Decoded_VkAllocationCallbacks>& pAllocator)
{
    ...
    OverrideFreeMemory(vkFreeMemory, in_device, in_memory, in_pAllocator);
}
    ...
    const PointerDecoder<uint64_t>&             ppData)
{
    ...
    VkResult replay_result = OverrideMapMemory(vkMapMemory, returnValue, in_device, in_memory, offset, size, flags, out_ppData);
    ...
    format::HandleId                            memory)
{
    ...
    OverrideUnmapMemory(vkUnmapMemory, in_device, in_memory);
}
    ...
    const StructPointerDecoder<Decoded_VkMappedMemoryRange>& pMemoryRanges)
{
    ...
    VkResult replay_result = vkFlushMappedMemoryRanges(in_device, memoryRangeCount, in_pMemoryRanges);
    ...
    const StructPointerDecoder<Decoded_VkMappedMemoryRange>& pMemoryRanges)
{
    ...
    VkResult replay_result = vkInvalidateMappedMemoryRanges(in_device, memoryRangeCount, in_pMemoryRanges);
    ...
    VkDeviceSize                                memoryOffset)
{
    ...
    VkResult replay_result = vkBindBufferMemory(in_device, in_buffer, in_memory, memoryOffset);
    ...
    VkDeviceSize                                memoryOffset)
{
    ...
    VkResult replay_result = vkBindImageMemory(in_device, in_image, in_memory, memoryOffset);
    ...
    format::HandleId                            fence)
{
    ...
    VkResult replay_result = vkQueueBindSparse(in_queue, bindInfoCount, in_pBindInfo, in_fence);
    ...
    const HandlePointerDecoder<VkFence>&        pFence)
{
    ...
    VkResult replay_result = vkCreateFence(in_device, in_pCreateInfo, in_pAllocator, out_pFence);
    ...
    const HandlePointerDecoder<VkFence>&        pFences)
{
    ...
    VkResult replay_result = vkResetFences(in_device, fenceCount, in_pFences);
    ...
    format::HandleId                            fence)
{
    ...
    VkResult replay_result = OverrideGetFenceStatus(vkGetFenceStatus, returnValue, in_device, in_fence);
    ...
    uint64_t                                    timeout)
{
    ...
    VkResult replay_result = OverrideWaitForFences(vkWaitForFences, returnValue, in_device, fenceCount, in_pFences, waitAll, timeout);
    ...
    const HandlePointerDecoder<VkSemaphore>&    pSemaphore)
{
    ...
    VkResult replay_result = vkCreateSemaphore(in_device, in_pCreateInfo, in_pAllocator, out_pSemaphore);
    ...
    const HandlePointerDecoder<VkEvent>&        pEvent)
{
    ...
    VkResult replay_result = vkCreateEvent(in_device, in_pCreateInfo, in_pAllocator, out_pEvent);
    ...
    format::HandleId                            event)
{
    ...
    VkResult replay_result = OverrideGetEventStatus(vkGetEventStatus, returnValue, in_device, in_event);
    ...
    format::HandleId                            event)
{
    ...
    VkResult replay_result = vkSetEvent(in_device, in_event);
    ...
    format::HandleId                            event)
{
    ...
    VkResult replay_result = vkResetEvent(in_device, in_event);
    ...
    const HandlePointerDecoder<VkQueryPool>&    pQueryPool)
{
    ...
    VkResult replay_result = vkCreateQueryPool(in_device, in_pCreateInfo, in_pAllocator, out_pQueryPool);
    ...
    VkQueryResultFlags                          flags)
{
    ...
    VkResult replay_result = OverrideGetQueryPoolResults(vkGetQueryPoolResults, returnValue, in_device, in_queryPool, firstQuery, queryCount, dataSize, out_pData, stride, flags);
    ...
    const HandlePointerDecoder<VkBuffer>&       pBuffer)
{
    ...
    VkResult replay_result = vkCreateBuffer(in_device, in_pCreateInfo, in_pAllocator, out_pBuffer);
    ...
    const HandlePointerDecoder<VkBufferView>&   pView)
{
    ...
    VkResult replay_result = vkCreateBufferView(in_device, in_pCreateInfo, in_pAllocator, out_pView);
    ...
    const HandlePointerDecoder<VkImage>&        pImage)
{
    ...
    VkResult replay_result = vkCreateImage(in_device, in_pCreateInfo, in_pAllocator, out_pImage);
    ...
    const HandlePointerDecoder<VkImageView>&    pView)
{
    ...
    VkResult replay_result = vkCreateImageView(in_device, in_pCreateInfo, in_pAllocator, out_pView);
    ...
    const HandlePointerDecoder<VkShaderModule>& pShaderModule)
{
    ...
    VkResult replay_result = vkCreateShaderModule(in_device, in_pCreateInfo, in_pAllocator, out_pShaderModule);
    ...
    const HandlePointerDecoder<VkPipelineCache>& pPipelineCache)
{
    ...
    VkResult replay_result = vkCreatePipelineCache(in_device, in_pCreateInfo, in_pAllocator, out_pPipelineCache);
    ...
    const PointerDecoder<uint8_t>&              pData)
{
    ...
    VkResult replay_result = vkGetPipelineCacheData(in_device, in_pipelineCache, out_pDataSize, out_pData);
    ...
    const HandlePointerDecoder<VkPipelineCache>& pSrcCaches)
{
    ...
    VkResult replay_result = vkMergePipelineCaches(in_device, in_dstCache, srcCacheCount, in_pSrcCaches);
    ...
    const HandlePointerDecoder<VkPipeline>&     pPipelines)
{
    ...
    VkResult replay_result = vkCreateGraphicsPipelines(in_device, in_pipelineCache, createInfoCount, in_pCreateInfos, in_pAllocator, out_pPipelines);
    ...
    const HandlePointerDecoder<VkPipeline>&     pPipelines)
{
    ...
    VkResult replay_result = vkCreateComputePipelines(in_device, in_pipelineCache, createInfoCount, in_pCreateInfos, in_pAllocator, out_pPipelines);
    ...
    const HandlePointerDecoder<VkPipelineLayout>& pPipelineLayout)
{
    ...
    VkResult replay_result = vkCreatePipelineLayout(in_device, in_pCreateInfo, in_pAllocator, out_pPipelineLayout);
    ...
    const HandlePointerDecoder<VkSampler>&      pSampler)
{
    ...
    VkResult replay_result = vkCreateSampler(in_device, in_pCreateInfo, in_pAllocator, out_pSampler);
    ...
    const HandlePointerDecoder<VkDescriptorSetLayout>& pSetLayout)
{
    ...
    VkResult replay_result = vkCreateDescriptorSetLayout(in_device, in_pCreateInfo, in_pAllocator, out_pSetLayout);
    ...
    const HandlePointerDecoder<VkDescriptorPool>& pDescriptorPool)
{
    ...
    VkResult replay_result = vkCreateDescriptorPool(in_device, in_pCreateInfo, in_pAllocator, out_pDescriptorPool);
    ...
    VkDescriptorPoolResetFlags                  flags)
{
    ...
    VkResult replay_result = vkResetDescriptorPool(in_device, in_descriptorPool, flags);
    ...
    const HandlePointerDecoder<VkDescriptorSet>& pDescriptorSets)
{
    ...
    VkResult replay_result = vkAllocateDescriptorSets(in_device, in_pAllocateInfo, out_pDescriptorSets);
    ...
    const HandlePointerDecoder<VkDescriptorSet>& pDescriptorSets)
{
    ...
    VkResult replay_result = vkFreeDescriptorSets(in_device, in_descriptorPool, descriptorSetCount, in_pDescriptorSets);
    ...
    const HandlePointerDecoder<VkFramebuffer>&  pFramebuffer)
{
    ...
    VkResult replay_result = vkCreateFramebuffer(in_device, in_pCreateInfo, in_pAllocator, out_pFramebuffer);
    ...
    const HandlePointerDecoder<VkRenderPass>&   pRenderPass)
{
    ...
    VkResult replay_result = vkCreateRenderPass(in_device, in_pCreateInfo, in_pAllocator, out_pRenderPass);
    ...
    const HandlePointerDecoder<VkCommandPool>&  pCommandPool)
{
    ...
    VkResult replay_result = vkCreateCommandPool(in_device, in_pCreateInfo, in_pAllocator, out_pCommandPool);
    ...
    VkCommandPoolResetFlags                     flags)
{
    ...
    VkResult replay_result = vkResetCommandPool(in_device, in_commandPool, flags);
    ...
    const HandlePointerDecoder<VkCommandBuffer>& pCommandBuffers)
{
    ...
    VkResult replay_result = vkAllocateCommandBuffers(in_device, in_pAllocateInfo, out_pCommandBuffers);
    ...
    const StructPointerDecoder<Decoded_VkCommandBufferBeginInfo>& pBeginInfo)
{
    ...
    VkResult replay_result = vkBeginCommandBuffer(in_commandBuffer, in_pBeginInfo);
    ...
    format::HandleId                            commandBuffer)
{
    ...
    VkResult replay_result = vkEndCommandBuffer(in_commandBuffer);
    ...
    VkCommandBufferResetFlags                   flags)
{
    ...
    VkResult replay_result = vkResetCommandBuffer(in_commandBuffer, flags);
    ...
    const StructPointerDecoder<Decoded_VkBindBufferMemoryInfo>& pBindInfos)
{
    ...
    VkResult replay_result = vkBindBufferMemory2(in_device, bindInfoCount, in_pBindInfos);
    ...
    const StructPointerDecoder<Decoded_VkBindImageMemoryInfo>& pBindInfos)
{
    ...
    VkResult replay_result = vkBindImageMemory2(in_device, bindInfoCount, in_pBindInfos);
    ...
    const StructPointerDecoder<Decoded_VkPhysicalDeviceGroupProperties>& pPhysicalDeviceGroupProperties)
{
    ...
    VkResult replay_result = vkEnumeratePhysicalDeviceGroups(in_instance, out_pPhysicalDeviceGroupCount, out_pPhysicalDeviceGroupProperties);
    ...
    const StructPointerDecoder<Decoded_VkImageFormatProperties2>& pImageFormatProperties)
{
    ...
    VkResult replay_result = vkGetPhysicalDeviceImageFormatProperties2(in_physicalDevice, in_pImageFormatInfo, out_pImageFormatProperties);
    ...
    const HandlePointerDecoder<VkSamplerYcbcrConversion>& pYcbcrConversion)
{
    ...
    VkResult replay_result = vkCreateSamplerYcbcrConversion(in_device, in_pCreateInfo, in_pAllocator, out_pYcbcrConversion);
    ...
    const HandlePointerDecoder<VkDescriptorUpdateTemplate>& pDescriptorUpdateTemplate)
{
    ...
    VkResult replay_result = OverrideCreateDescriptorUpdateTemplate(vkCreateDescriptorUpdateTemplate, returnValue, in_device, in_pCreateInfo, in_pAllocator, out_pDescriptorUpdateTemplate);
    ...
    const StructPointerDecoder<Decoded_VkAllocationCallbacks>& pAllocator)
{
    ...
    OverrideDestroySurfaceKHR(vkDestroySurfaceKHR, in_instance, in_surface, in_pAllocator);
}
    ...
    const PointerDecoder<VkBool32>&             pSupported)
{
    ...
    VkResult replay_result = vkGetPhysicalDeviceSurfaceSupportKHR(in_physicalDevice, queueFamilyIndex, in_surface, out_pSupported);
    ...
    const StructPointerDecoder<Decoded_VkSurfaceCapabilitiesKHR>& pSurfaceCapabilities)
{
    ...
    VkResult replay_result = vkGetPhysicalDeviceSurfaceCapabilitiesKHR(in_physicalDevice, in_surface, out_pSurfaceCapabilities);
    ...
    const StructPointerDecoder<Decoded_VkSurfaceFormatKHR>& pSurfaceFormats)
{
    ...
    VkResult replay_result = vkGetPhysicalDeviceSurfaceFormatsKHR(in_physicalDevice, in_surface, out_pSurfaceFormatCount, out_pSurfaceFormats);
    ...
    const PointerDecoder<VkPresentModeKHR>&     pPresentModes)
{
    ...
    VkResult replay_result = vkGetPhysicalDeviceSurfacePresentModesKHR(in_physicalDevice, in_surface, out_pPresentModeCount, out_pPresentModes);
    ...
    const HandlePointerDecoder<VkSwapchainKHR>& pSwapchain)
{
    ...
    VkResult replay_result = vkCreateSwapchainKHR(in_device, in_pCreateInfo, in_pAllocator, out_pSwapchain);
    ...
    const HandlePointerDecoder<VkImage>&        pSwapchainImages)
{
    ...
    VkResult replay_result = vkGetSwapchainImagesKHR(in_device, in_swapchain, out_pSwapchainImageCount, out_pSwapchainImages);
    ...
    const PointerDecoder<uint32_t>&             pImageIndex)
{
    ...
    VkResult replay_result = vkAcquireNextImageKHR(in_device, in_swapchain, timeout, in_semaphore, in_fence, out_pImageIndex);
    ...
    const StructPointerDecoder<Decoded_VkPresentInfoKHR>& pPresentInfo)
{
    ...
    VkResult replay_result = vkQueuePresentKHR(in_queue, in_pPresentInfo);
    ...
    const StructPointerDecoder<Decoded_VkDeviceGroupPresentCapabilitiesKHR>& pDeviceGroupPresentCapabilities)
{
    ...
    VkResult replay_result = vkGetDeviceGroupPresentCapabilitiesKHR(in_device, out_pDeviceGroupPresentCapabilities);
    ...
    const PointerDecoder<VkDeviceGroupPresentModeFlagsKHR>& pModes)
{
    ...
    VkResult replay_result = vkGetDeviceGroupSurfacePresentModesKHR(in_device, in_surface, out_pModes);
    ...
    const StructPointerDecoder<Decoded_VkRect2D>& pRects)
{
    ...
    VkResult replay_result = vkGetPhysicalDevicePresentRectanglesKHR(in_physicalDevice, in_surface, out_pRectCount, out_pRects);
    ...
    const PointerDecoder<uint32_t>&             pImageIndex)
{
    ...
    VkResult replay_result = vkAcquireNextImage2KHR(in_device, in_pAcquireInfo, out_pImageIndex);
    ...
    const StructPointerDecoder<Decoded_VkDisplayPropertiesKHR>& pProperties)
{
    ...
    VkResult replay_result = vkGetPhysicalDeviceDisplayPropertiesKHR(in_physicalDevice, out_pPropertyCount, out_pProperties);
    ...
    const StructPointerDecoder<Decoded_VkDisplayPlanePropertiesKHR>& pProperties)
{
    ...
    VkResult replay_result = vkGetPhysicalDeviceDisplayPlanePropertiesKHR(in_physicalDevice, out_pPropertyCount, out_pProperties);
    ...
    const HandlePointerDecoder<VkDisplayKHR>&   pDisplays)
{
    ...
    VkResult replay_result = vkGetDisplayPlaneSupportedDisplaysKHR(in_physicalDevice, planeIndex, out_pDisplayCount, out_pDisplays);
    ...
    const StructPointerDecoder<Decoded_VkDisplayModePropertiesKHR>& pProperties)
{
    ...
    VkResult replay_result = vkGetDisplayModePropertiesKHR(in_physicalDevice, in_display, out_pPropertyCount, out_pProperties);
    ...
    const HandlePointerDecoder<VkDisplayModeKHR>& pMode)
{
    ...
    VkResult replay_result = vkCreateDisplayModeKHR(in_physicalDevice, in_display, in_pCreateInfo, in_pAllocator, out_pMode);
    ...
    const StructPointerDecoder<Decoded_VkDisplayPlaneCapabilitiesKHR>& pCapabilities)
{
    ...
    VkResult replay_result = vkGetDisplayPlaneCapabilitiesKHR(in_physicalDevice, in_mode, planeIndex, out_pCapabilities);
    ...
    const HandlePointerDecoder<VkSurfaceKHR>&   pSurface)
{
    ...
    VkResult replay_result = vkCreateDisplayPlaneSurfaceKHR(in_instance, in_pCreateInfo, in_pAllocator, out_pSurface);
    ...
    const HandlePointerDecoder<VkSwapchainKHR>& pSwapchains)
{
    ...
    VkResult replay_result = vkCreateSharedSwapchainsKHR(in_device, swapchainCount, in_pCreateInfos, in_pAllocator, out_pSwapchains);
    ...
    const HandlePointerDecoder<VkSurfaceKHR>&   pSurface)
{
    ...
    VkResult replay_result = OverrideCreateXlibSurfaceKHR(vkCreateXlibSurfaceKHR, returnValue, in_instance, in_pCreateInfo, in_pAllocator, out_pSurface);
    ...
    size_t                                      visualID)
{
    ...
    OverrideGetPhysicalDeviceXlibPresentationSupportKHR(vkGetPhysicalDeviceXlibPresentationSupportKHR, in_physicalDevice, queueFamilyIndex, in_dpy, visualID);
}
    ...
    const HandlePointerDecoder<VkSurfaceKHR>&   pSurface)
{
    ...
    VkResult replay_result = OverrideCreateXcbSurfaceKHR(vkCreateXcbSurfaceKHR, returnValue, in_instance, in_pCreateInfo, in_pAllocator, out_pSurface);
    ...
    uint32_t                                    visual_id)
{
    ...
    OverrideGetPhysicalDeviceXcbPresentationSupportKHR(vkGetPhysicalDeviceXcbPresentationSupportKHR, in_physicalDevice, queueFamilyIndex, in_connection, visual_id);
}
    ...
    const HandlePointerDecoder<VkSurfaceKHR>&   pSurface)
{
    ...
    VkResult replay_result = OverrideCreateWaylandSurfaceKHR(vkCreateWaylandSurfaceKHR, returnValue, in_instance, in_pCreateInfo, in_pAllocator, out_pSurface);
    ...
    uint64_t                                    display)
{
    ...
    OverrideGetPhysicalDeviceWaylandPresentationSupportKHR(vkGetPhysicalDeviceWaylandPresentationSupportKHR, in_physicalDevice, queueFamilyIndex, in_display);
}
    ...
    const HandlePointerDecoder<VkSurfaceKHR>&   pSurface)
{
    ...
    VkResult replay_result = OverrideCreateAndroidSurfaceKHR(vkCreateAndroidSurfaceKHR, returnValue, in_instance, in_pCreateInfo, in_pAllocator, out_pSurface);
    ...
    const HandlePointerDecoder<VkSurfaceKHR>&   pSurface)
{
    ...
    VkResult replay_result = OverrideCreateWin32SurfaceKHR(vkCreateWin32SurfaceKHR, returnValue, in_instance, in_pCreateInfo, in_pAllocator, out_pSurface);
    ...
    uint32_t                                    queueFamilyIndex)
{
    ...
    OverrideGetPhysicalDeviceWin32PresentationSupportKHR(vkGetPhysicalDeviceWin32PresentationSupportKHR, in_physicalDevice, queueFamilyIndex);
}
    ...
    const StructPointerDecoder<Decoded_VkImageFormatProperties2>& pImageFormatProperties)
{
    ...
    VkResult replay_result = vkGetPhysicalDeviceImageFormatProperties2KHR(in_physicalDevice, in_pImageFormatInfo, out_pImageFormatProperties);
    ...
    const StructPointerDecoder<Decoded_VkPhysicalDeviceGroupProperties>& pPhysicalDeviceGroupProperties)
{
    ...
    VkResult replay_result = vkEnumeratePhysicalDeviceGroupsKHR(in_instance, out_pPhysicalDeviceGroupCount, out_pPhysicalDeviceGroupProperties);
    ...
    const PointerDecoder<uint64_t>&             pHandle)
{
    ...
    VkResult replay_result = vkGetMemoryWin32HandleKHR(in_device, in_pGetWin32HandleInfo, out_pHandle);
    ...
    const StructPointerDecoder<Decoded_VkMemoryWin32HandlePropertiesKHR>& pMemoryWin32HandleProperties)
{
    ...
    VkResult replay_result = vkGetMemoryWin32HandlePropertiesKHR(in_device, handleType, in_handle, out_pMemoryWin32HandleProperties);
    ...
    const PointerDecoder<int>&                  pFd)
{
    ...
    VkResult replay_result = vkGetMemoryFdKHR(in_device, in_pGetFdInfo, out_pFd);
    ...
    const StructPointerDecoder<Decoded_VkMemoryFdPropertiesKHR>& pMemoryFdProperties)
{
    ...
    VkResult replay_result = vkGetMemoryFdPropertiesKHR(in_device, handleType, fd, out_pMemoryFdProperties);
    ...
    const StructPointerDecoder<Decoded_VkImportSemaphoreWin32HandleInfoKHR>& pImportSemaphoreWin32HandleInfo)
{
    ...
    VkResult replay_result = vkImportSemaphoreWin32HandleKHR(in_device, in_pImportSemaphoreWin32HandleInfo);
    ...
    const PointerDecoder<uint64_t>&             pHandle)
{
    ...
    VkResult replay_result = vkGetSemaphoreWin32HandleKHR(in_device, in_pGetWin32HandleInfo, out_pHandle);
    ...
    const StructPointerDecoder<Decoded_VkImportSemaphoreFdInfoKHR>& pImportSemaphoreFdInfo)
{
    ...
    VkResult replay_result = vkImportSemaphoreFdKHR(in_device, in_pImportSemaphoreFdInfo);
    ...
    const PointerDecoder<int>&                  pFd)
{
    ...
    VkResult replay_result = vkGetSemaphoreFdKHR(in_device, in_pGetFdInfo, out_pFd);
    ...
    const HandlePointerDecoder<VkDescriptorUpdateTemplate>& pDescriptorUpdateTemplate)
{
    ...
    VkResult replay_result = OverrideCreateDescriptorUpdateTemplate(vkCreateDescriptorUpdateTemplateKHR, returnValue, in_device, in_pCreateInfo, in_pAllocator, out_pDescriptorUpdateTemplate);
    ...
    const HandlePointerDecoder<VkRenderPass>&   pRenderPass)
{
    ...
    VkResult replay_result = vkCreateRenderPass2KHR(in_device, in_pCreateInfo, in_pAllocator, out_pRenderPass);
    ...
    format::HandleId                            swapchain)
{
    ...
    VkResult replay_result = vkGetSwapchainStatusKHR(in_device, in_swapchain);
    ...
    const StructPointerDecoder<Decoded_VkImportFenceWin32HandleInfoKHR>& pImportFenceWin32HandleInfo)
{
    ...
    VkResult replay_result = vkImportFenceWin32HandleKHR(in_device, in_pImportFenceWin32HandleInfo);
    ...
    const PointerDecoder<uint64_t>&             pHandle)
{
    ...
    VkResult replay_result = vkGetFenceWin32HandleKHR(in_device, in_pGetWin32HandleInfo, out_pHandle);
    ...
    const StructPointerDecoder<Decoded_VkImportFenceFdInfoKHR>& pImportFenceFdInfo)
{
    ...
    VkResult replay_result = vkImportFenceFdKHR(in_device, in_pImportFenceFdInfo);
    ...
    const PointerDecoder<int>&                  pFd)
{
    ...
    VkResult replay_result = vkGetFenceFdKHR(in_device, in_pGetFdInfo, out_pFd);
    ...
    const StructPointerDecoder<Decoded_VkSurfaceCapabilities2KHR>& pSurfaceCapabilities)
{
    ...
    VkResult replay_result = vkGetPhysicalDeviceSurfaceCapabilities2KHR(in_physicalDevice, in_pSurfaceInfo, out_pSurfaceCapabilities);
    ...
    const StructPointerDecoder<Decoded_VkSurfaceFormat2KHR>& pSurfaceFormats)
{
    ...
    VkResult replay_result = vkGetPhysicalDeviceSurfaceFormats2KHR(in_physicalDevice, in_pSurfaceInfo, out_pSurfaceFormatCount, out_pSurfaceFormats);
    ...
    const StructPointerDecoder<Decoded_VkDisplayProperties2KHR>& pProperties)
{
    ...
    VkResult replay_result = vkGetPhysicalDeviceDisplayProperties2KHR(in_physicalDevice, out_pPropertyCount, out_pProperties);
    ...
    const StructPointerDecoder<Decoded_VkDisplayPlaneProperties2KHR>& pProperties)
{
    ...
    VkResult replay_result = vkGetPhysicalDeviceDisplayPlaneProperties2KHR(in_physicalDevice, out_pPropertyCount, out_pProperties);
    ...
    const StructPointerDecoder<Decoded_VkDisplayModeProperties2KHR>& pProperties)
{
    ...
    VkResult replay_result = vkGetDisplayModeProperties2KHR(in_physicalDevice, in_display, out_pPropertyCount, out_pProperties);
    ...
    const StructPointerDecoder<Decoded_VkDisplayPlaneCapabilities2KHR>& pCapabilities)
{
    ...
    VkResult replay_result = vkGetDisplayPlaneCapabilities2KHR(in_physicalDevice, in_pDisplayPlaneInfo, out_pCapabilities);
    ...
    const HandlePointerDecoder<VkSamplerYcbcrConversion>& pYcbcrConversion)
{
    ...
    VkResult replay_result = vkCreateSamplerYcbcrConversionKHR(in_device, in_pCreateInfo, in_pAllocator, out_pYcbcrConversion);
    ...
    const StructPointerDecoder<Decoded_VkBindBufferMemoryInfo>& pBindInfos)
{
    ...
    VkResult replay_result = vkBindBufferMemory2KHR(in_device, bindInfoCount, in_pBindInfos);
    ...
    const StructPointerDecoder<Decoded_VkBindImageMemoryInfo>& pBindInfos)
{
    ...
    VkResult replay_result = vkBindImageMemory2KHR(in_device, bindInfoCount, in_pBindInfos);
    ...
    const HandlePointerDecoder<VkDebugReportCallbackEXT>& pCallback)
{
    ...
    VkResult replay_result = vkCreateDebugReportCallbackEXT(in_instance, in_pCreateInfo, in_pAllocator, out_pCallback);
    ...
    const StructPointerDecoder<Decoded_VkDebugMarkerObjectTagInfoEXT>& pTagInfo)
{
    ...
    VkResult replay_result = vkDebugMarkerSetObjectTagEXT(in_device, in_pTagInfo);
    ...
    const StructPointerDecoder<Decoded_VkDebugMarkerObjectNameInfoEXT>& pNameInfo)
{
    ...
    VkResult replay_result = vkDebugMarkerSetObjectNameEXT(in_device, in_pNameInfo);
    ...
    const PointerDecoder<VkDeviceSize>&         pSizes)
{
    ...
    vkCmdBindTransformFeedbackBuffersEXT(in_commandBuffer, firstBinding, bindingCount, in_pBuffers, in_pOffsets, in_pSizes);
}
    ...
    const PointerDecoder<VkDeviceSize>&         pCounterBufferOffsets)
{
    ...
    vkCmdBeginTransformFeedbackEXT(in_commandBuffer, firstCounterBuffer, counterBufferCount, in_pCounterBuffers, in_pCounterBufferOffsets);
}
    ...
    const PointerDecoder<VkDeviceSize>&         pCounterBufferOffsets)
{
    ...
    vkCmdEndTransformFeedbackEXT(in_commandBuffer, firstCounterBuffer, counterBufferCount, in_pCounterBuffers, in_pCounterBufferOffsets);
}
    ...
    uint32_t                                    index)
{
    ...
    vkCmdBeginQueryIndexedEXT(in_commandBuffer, in_queryPool, query, flags, index);
}
    ...
    uint32_t                                    index)
{
    ...
    vkCmdEndQueryIndexedEXT(in_commandBuffer, in_queryPool, query, index);
}
    ...
    uint32_t                                    vertexStride)
{
    ...
    vkCmdDrawIndirectByteCountEXT(in_commandBuffer, instanceCount, firstInstance, in_counterBuffer, counterBufferOffset, counterOffset, vertexStride);
}
    ...
    const StructPointerDecoder<Decoded_VkImageViewHandleInfoNVX>& pInfo)
{
    ...
    vkGetImageViewHandleNVX(in_device, in_pInfo);
}
    ...
    const PointerDecoder<uint8_t>&              pInfo)
{
    ...
    VkResult replay_result = vkGetShaderInfoAMD(in_device, in_pipeline, shaderStage, infoType, out_pInfoSize, out_pInfo);
    ...
    const StructPointerDecoder<Decoded_VkExternalImageFormatPropertiesNV>& pExternalImageFormatProperties)
{
    ...
    VkResult replay_result = vkGetPhysicalDeviceExternalImageFormatPropertiesNV(in_physicalDevice, format, type, tiling, usage, flags, externalHandleType, out_pExternalImageFormatProperties);
    ...
    const PointerDecoder<uint64_t>&             pHandle)
{
    ...
    VkResult replay_result = vkGetMemoryWin32HandleNV(in_device, in_memory, handleType, out_pHandle);
    ...
    const HandlePointerDecoder<VkSurfaceKHR>&   pSurface)
{
    ...
    VkResult replay_result = vkCreateViSurfaceNN(in_instance, in_pCreateInfo, in_pAllocator, out_pSurface);
    ...
    const HandlePointerDecoder<VkIndirectCommandsLayoutNVX>& pIndirectCommandsLayout)
{
    ...
    VkResult replay_result = vkCreateIndirectCommandsLayoutNVX(in_device, in_pCreateInfo, in_pAllocator, out_pIndirectCommandsLayout);
    ...
    const HandlePointerDecoder<VkObjectTableNVX>& pObjectTable)
{
    ...
    VkResult replay_result = vkCreateObjectTableNVX(in_device, in_pCreateInfo, in_pAllocator, out_pObjectTable);
    ...
    const PointerDecoder<uint32_t>&             pObjectIndices)
{
    ...
    VkResult replay_result = vkUnregisterObjectsNVX(in_device, in_objectTable, objectCount, in_pObjectEntryTypes, in_pObjectIndices);
    ...
    format::HandleId                            display)
{
    ...
    VkResult replay_result = vkReleaseDisplayEXT(in_physicalDevice, in_display);
    ...
    format::HandleId                            display)
{
    ...
    VkResult replay_result = vkAcquireXlibDisplayEXT(in_physicalDevice, in_dpy, in_display);
    ...
    const HandlePointerDecoder<VkDisplayKHR>&   pDisplay)
{
    ...
    VkResult replay_result = vkGetRandROutputDisplayEXT(in_physicalDevice, in_dpy, rrOutput, out_pDisplay);
    ...
    const StructPointerDecoder<Decoded_VkSurfaceCapabilities2EXT>& pSurfaceCapabilities)
{
    ...
    VkResult replay_result = vkGetPhysicalDeviceSurfaceCapabilities2EXT(in_physicalDevice, in_surface, out_pSurfaceCapabilities);
    ...
    const StructPointerDecoder<Decoded_VkDisplayPowerInfoEXT>& pDisplayPowerInfo)
{
    ...
    VkResult replay_result = vkDisplayPowerControlEXT(in_device, in_display, in_pDisplayPowerInfo);
    ...
    const HandlePointerDecoder<VkFence>&        pFence)
{
    ...
    VkResult replay_result = vkRegisterDeviceEventEXT(in_device, in_pDeviceEventInfo, in_pAllocator, out_pFence);
    ...
    const HandlePointerDecoder<VkFence>&        pFence)
{
    ...
    VkResult replay_result = vkRegisterDisplayEventEXT(in_device, in_display, in_pDisplayEventInfo, in_pAllocator, out_pFence);
    ...
    const PointerDecoder<uint64_t>&             pCounterValue)
{
    ...
    VkResult replay_result = vkGetSwapchainCounterEXT(in_device, in_swapchain, counter, out_pCounterValue);
    ...
    const StructPointerDecoder<Decoded_VkRefreshCycleDurationGOOGLE>& pDisplayTimingProperties)
{
    ...
    VkResult replay_result = vkGetRefreshCycleDurationGOOGLE(in_device, in_swapchain, out_pDisplayTimingProperties);
    ...
    const StructPointerDecoder<Decoded_VkPastPresentationTimingGOOGLE>& pPresentationTimings)
{
    ...
    VkResult replay_result = vkGetPastPresentationTimingGOOGLE(in_device, in_swapchain, out_pPresentationTimingCount, out_pPresentationTimings);
    ...
    const HandlePointerDecoder<VkSurfaceKHR>&   pSurface)
{
    ...
    VkResult replay_result = vkCreateIOSSurfaceMVK(in_instance, in_pCreateInfo, in_pAllocator, out_pSurface);
    ...
    const HandlePointerDecoder<VkSurfaceKHR>&   pSurface)
{
    ...
    VkResult replay_result = vkCreateMacOSSurfaceMVK(in_instance, in_pCreateInfo, in_pAllocator, out_pSurface);
    ...
    const StructPointerDecoder<Decoded_VkDebugUtilsObjectNameInfoEXT>& pNameInfo)
{
    ...
    VkResult replay_result = vkSetDebugUtilsObjectNameEXT(in_device, in_pNameInfo);
    ...
    const StructPointerDecoder<Decoded_VkDebugUtilsObjectTagInfoEXT>& pTagInfo)
{
    ...
    VkResult replay_result = vkSetDebugUtilsObjectTagEXT(in_device, in_pTagInfo);
    ...
    const HandlePointerDecoder<VkDebugUtilsMessengerEXT>& pMessenger)
{
    ...
    VkResult replay_result = vkCreateDebugUtilsMessengerEXT(in_instance, in_pCreateInfo, in_pAllocator, out_pMessenger);
    ...
    const StructPointerDecoder<Decoded_VkAndroidHardwareBufferPropertiesANDROID>& pProperties)
{
    ...
    VkResult replay_result = vkGetAndroidHardwareBufferPropertiesANDROID(in_device, in_buffer, out_pProperties);
    ...
    const PointerDecoder<uint64_t>&             pBuffer)
{
    ...
    VkResult replay_result = vkGetMemoryAndroidHardwareBufferANDROID(in_device, in_pInfo, out_pBuffer);
    ...
    const StructPointerDecoder<Decoded_VkImageDrmFormatModifierPropertiesEXT>& pProperties)
{
    ...
    VkResult replay_result = vkGetImageDrmFormatModifierPropertiesEXT(in_device, in_image, out_pProperties);
    ...
    const HandlePointerDecoder<VkValidationCacheEXT>& pValidationCache)
{
    ...
    VkResult replay_result = vkCreateValidationCacheEXT(in_device, in_pCreateInfo, in_pAllocator, out_pValidationCache);
    ...
    const HandlePointerDecoder<VkValidationCacheEXT>& pSrcCaches)
{
    ...
    VkResult replay_result = vkMergeValidationCachesEXT(in_device, in_dstCache, srcCacheCount, in_pSrcCaches);
    ...
    const PointerDecoder<uint8_t>&              pData)
{
    ...
    VkResult replay_result = vkGetValidationCacheDataEXT(in_device, in_validationCache, out_pDataSize, out_pData);
    ...
    VkImageLayout                               imageLayout)
{
    ...
    vkCmdBindShadingRateImageNV(in_commandBuffer, in_imageView, imageLayout);
}
    ...
    const StructPointerDecoder<Decoded_VkShadingRatePaletteNV>& pShadingRatePalettes)
{
    ...
    vkCmdSetViewportShadingRatePaletteNV(in_commandBuffer, firstViewport, viewportCount, in_pShadingRatePalettes);
}
    ...
    const StructPointerDecoder<Decoded_VkCoarseSampleOrderCustomNV>& pCustomSampleOrders)
{
    ...
    vkCmdSetCoarseSampleOrderNV(in_commandBuffer, sampleOrderType, customSampleOrderCount, in_pCustomSampleOrders);
}
    ...
    const HandlePointerDecoder<VkAccelerationStructureNV>& pAccelerationStructure)
{
    ...
    VkResult replay_result = vkCreateAccelerationStructureNV(in_device, in_pCreateInfo, in_pAllocator, out_pAccelerationStructure);
    ...
    const StructPointerDecoder<Decoded_VkAllocationCallbacks>& pAllocator)
{
    ...
    vkDestroyAccelerationStructureNV(in_device, in_accelerationStructure, in_pAllocator);
}
    ...
    const StructPointerDecoder<Decoded_VkMemoryRequirements2KHR>& pMemoryRequirements)
{
    ...
    vkGetAccelerationStructureMemoryRequirementsNV(in_device, in_pInfo, out_pMemoryRequirements);
}
    ...
    const StructPointerDecoder<Decoded_VkBindAccelerationStructureMemoryInfoNV>& pBindInfos)
{
    ...
    VkResult replay_result = vkBindAccelerationStructureMemoryNV(in_device, bindInfoCount, in_pBindInfos);
    ...
    VkDeviceSize                                scratchOffset)
{
    ...
    vkCmdBuildAccelerationStructureNV(in_commandBuffer, in_pInfo, in_instanceData, instanceOffset, update, in_dst, in_src, in_scratch, scratchOffset);
}
    ...
    VkCopyAccelerationStructureModeNV           mode)
{
    ...
    vkCmdCopyAccelerationStructureNV(in_commandBuffer, in_dst, in_src, mode);
}
    ...
    const HandlePointerDecoder<VkPipeline>&     pPipelines)
{
    ...
    VkResult replay_result = vkCreateRayTracingPipelinesNV(in_device, in_pipelineCache, createInfoCount, in_pCreateInfos, in_pAllocator, out_pPipelines);
    ...
    const PointerDecoder<uint8_t>&              pData)
{
    ...
    VkResult replay_result = vkGetRayTracingShaderGroupHandlesNV(in_device, in_pipeline, firstGroup, groupCount, dataSize, out_pData);
    ...
    const PointerDecoder<uint8_t>&              pData)
{
    ...
    VkResult replay_result = vkGetAccelerationStructureHandleNV(in_device, in_accelerationStructure, dataSize, out_pData);
    ...
    uint32_t                                    firstQuery)
{
    ...
    vkCmdWriteAccelerationStructuresPropertiesNV(in_commandBuffer, accelerationStructureCount, in_pAccelerationStructures, queryType, in_queryPool, firstQuery);
}
    ...
    uint32_t                                    shader)
{
    ...
    VkResult replay_result = vkCompileDeferredNV(in_device, in_pipeline, shader);
    ...
    const StructPointerDecoder<Decoded_VkMemoryHostPointerPropertiesEXT>& pMemoryHostPointerProperties)
{
    ...
    VkResult replay_result = vkGetMemoryHostPointerPropertiesEXT(in_device, handleType, in_pHostPointer, out_pMemoryHostPointerProperties);
    ...
    const PointerDecoder<VkTimeDomainEXT>&      pTimeDomains)
{
    ...
    VkResult replay_result = vkGetPhysicalDeviceCalibrateableTimeDomainsEXT(in_physicalDevice, out_pTimeDomainCount, out_pTimeDomains);
    ...
    const PointerDecoder<uint64_t>&             pMaxDeviation)
{
    ...
    VkResult replay_result = vkGetCalibratedTimestampsEXT(in_device, timestampCount, in_pTimestampInfos, out_pTimestamps, out_pMaxDeviation);
    ...
    uint32_t                                    firstTask)
{
    ...
    vkCmdDrawMeshTasksNV(in_commandBuffer, taskCount, firstTask);
}
    ...
    uint32_t                                    stride)
{
    ...
    vkCmdDrawMeshTasksIndirectNV(in_commandBuffer, in_buffer, offset, drawCount, stride);
}
    ...
    uint32_t                                    stride)
{
    ...
    vkCmdDrawMeshTasksIndirectCountNV(in_commandBuffer, in_buffer, offset, in_countBuffer, countBufferOffset, maxDrawCount, stride);
}
    ...
    const StructPointerDecoder<Decoded_VkRect2D>& pExclusiveScissors)
{
    ...
    vkCmdSetExclusiveScissorNV(in_commandBuffer, firstExclusiveScissor, exclusiveScissorCount, in_pExclusiveScissors);
}
    ...
    uint64_t                                    pCheckpointMarker)
{
    ...
    vkCmdSetCheckpointNV(in_commandBuffer, in_pCheckpointMarker);
}
    ...
    const StructPointerDecoder<Decoded_VkCheckpointDataNV>& pCheckpointData)
{
    ...
    vkGetQueueCheckpointDataNV(in_queue, out_pCheckpointDataCount, out_pCheckpointData);
    ...
    const HandlePointerDecoder<VkSurfaceKHR>&   pSurface)
{
    ...
    VkResult replay_result = vkCreateImagePipeSurfaceFUCHSIA(in_instance, in_pCreateInfo, in_pAllocator, out_pSurface);
    ...
    const HandlePointerDecoder<VkSurfaceKHR>&   pSurface)
{
    ...
    VkResult replay_result = vkCreateMetalSurfaceEXT(in_instance, in_pCreateInfo, in_pAllocator, out_pSurface);
    ...
    const StructPointerDecoder<Decoded_VkBufferDeviceAddressInfoEXT>& pInfo)
{
    ...
    vkGetBufferDeviceAddressEXT(in_device, in_pInfo);
}
    ...
    const StructPointerDecoder<Decoded_VkCooperativeMatrixPropertiesNV>& pProperties)
{
    ...
    VkResult replay_result = vkGetPhysicalDeviceCooperativeMatrixPropertiesNV(in_physicalDevice, out_pPropertyCount, out_pProperties);
