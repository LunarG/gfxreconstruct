    ...
    HandlePointerDecoder<VkBuffer>*                            buffer)
{
    ...
    assert((buffer != nullptr) && (buffer->GetHandlePointer() != nullptr));
    ...
    HandlePointerDecoder<VkImage>*                             image)
{
    ...
    assert((image != nullptr) && (image->GetHandlePointer() != nullptr));
    ...
    HandlePointerDecoder<VkDeviceMemory>*                      memory)
{
    ...
    assert((memory != nullptr) && (memory->GetHandlePointer() != nullptr));
    ...
    const StructPointerDecoder<Decoded_VkBindBufferMemoryInfo>* pBindInfos)
{
    ...
    assert(tracked_device_info != nullptr);
