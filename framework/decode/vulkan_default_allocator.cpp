...
const VulkanDefaultAllocator::ResourceData kUnusedResourceData =
    std::numeric_limits<VulkanDefaultAllocator::ResourceData>::max();
                                              ...
                                              ResourceData*                allocator_data)
{
    ...
    {
        (*allocator_data) = kUnusedResourceData;
    }
