    ...
    union {
        ...
        struct {
            union
            {
                ...
                INT     SDIAdapterSurfaceIndex; ///< index of remote SDI adapter surface
            };
...
struct AmdDxSDIQueryAllocInfo
{
    ...
    AmdDxSDISurfaceAttributes* pInfo;       ///< Input/output surface attribs for SDI surface
};

/**
***************************************************************************************************
* @brief
*    AmdDxSDIAdapterSurfaceInfo struct - SDI Adapter surface aatributes. Used to create the remote
...
struct AmdDxSDIAdapterSurfaceInfo
{
    ...
    AmdDxSDISurfaceAttributes surfAttrib; ///< Input/output surface attribs for SDI surface
};
