  ...
  -m <mode>             Enable memory translation for replay on GPUs with memory
                        ...
                        memory types.  Available modes are:
                            ...
                            rebind      Change memory allocation behavior based
                                        ...
                                        and suballocations.
  --emrp                Enable multipass (2-pass) replay portability for replay
                        on GPU with memory requirements that are different with
                        capture GPU (same as --enable-multipass-replay-portability).
```
### Keyboard Controls
